  ...
  return (
    <div className="min-h-screen pt-24 pb-16 px-6" style={{ background: "#0a0a14" }}>
      <div className="max-w-3xl mx-auto text-center">
        <h1 className="syne font-extrabold text-4xl md:text-5xl text-white mb-4">Security</h1>
        <p className="text-lg text-white/50 mb-12">Our comprehensive security model and compliance certifications.</p>
