  ...
  return (
    <div className="min-h-screen pt-24 pb-16 px-6" style={{ background: "#0a0a14" }}>
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h1 className="syne font-extrabold text-4xl md:text-5xl text-white mb-4">Enterprise <span className="glow-text">Solutions</span></h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-12">Corporate board voting, shareholder resolutions, and internal elections with complete audit trails.</p>
        <div className="glass rounded-3xl p-10 mb-8">
          <h2 className="syne text-2xl font-bold text-white mb-4">Why BallotChain for Enterprise?</h2>
