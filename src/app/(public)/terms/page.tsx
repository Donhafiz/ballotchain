  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a14", paddingTop: 80 }}>
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "40px 24px" }}>
        <h1 className="syne" style={{ fontSize: 32, fontWeight: 800, color: "#fff", marginBottom: 8 }}>Terms of Service</h1>
        ...
        <div className="glass rounded-3xl p-10" style={{ lineHeight: 1.8, fontSize: 14, color: "rgba(255,255,255,0.5)" }}>
          <p>This page outlines the terms of service for BallotChain. For specific questions, please contact our legal team.</p>
        </div>
      </div>
    </div>
  );
