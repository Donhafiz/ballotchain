        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-16">
            ...
            <div className="col-span-2">
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="syne font-bold text-base" style={{ color: "rgba(248,250,252,0.9)" }}>BallotChain</span>
              </div>
              <p className="text-sm leading-relaxed max-w-xs" style={{ color: "rgba(248,250,252,0.35)" }}>
                The world's most trusted voting infrastructure. Securing democracy
                at every scale since 2019.
              </p>
            </div>
            ...
            {[
              ...
              <div key={col.title}>
                <h4 className="syne font-bold text-xs tracking-widest uppercase mb-5"
          ...
          >
            <p className="text-xs" style={{ color: "rgba(248,250,252,0.22)" }}>
              © 2026 BallotChain Inc. All rights reserved.
            </p>
            <div className="flex items-center gap-2">
              <span className="relative w-2 h-2 rounded-full flex-shrink-0" style={{ background: "#22C55E" }}>
